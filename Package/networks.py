...
class DDDQN(nn.Module):
    ...
    def __init__(self, state_size, action_size):
        ...
        self.fc1 = nn.Linear(state_size, config["hyperparameters"]["HIDDEN_FEATURES"])
        self.fc2 = nn.Linear(
            config["hyperparameters"]["HIDDEN_FEATURES"],
            config["hyperparameters"]["HIDDEN_FEATURES"],
        )
        self.value_fc = nn.Linear(config["hyperparameters"]["HIDDEN_FEATURES"], 1)
    ...
    def _initialize_weights(self):
        ...
        initialization for the linear layers and zero initialization for the biases.
        """
